...
small_bottles_amount = input("How many small bottles do you have?")
big_bottles_amount = input("How many big bottles do you have?")
number_of_small_bottles = int(small_bottles_amount)
number_of_big_bottles = int(big_bottles_amount)
